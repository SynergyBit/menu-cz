...
const features = [
  {
    ...
    description: "Kompletní menu s cenami, popisy a alergeny. Zákazníci si prohlédnou nabídku ještě před návštěvou.",
    highlight: true,
  },
  {
    icon: QrCode,
    title: "QR kód s vlastním designem",
    description: "Vlastní barvy, rámečky s textem, stažení v PNG i SVG. Dejte na stoly, menu i vstup.",
    highlight: true,
  },
  {
    icon: CalendarDays,
    title: "Denní a týdenní menu",
    description: "Plánujte polední nabídku na celý týden dopředu. Šablony, kopírování — jedno kliknutí a hotovo.",
  },
  {
    icon: MapPin,
    title: "Viditelnost na mapě",
    description: "Interaktivní mapa s restauracemi. Geolokace — hosté najdou nejbližší podniky.",
  },
  {
    icon: Star,
    title: "Recenze a hodnocení",
    description: "Hosté hodnotí restauraci hvězdičkami a píší recenze. Dobré hodnocení přitahuje nové zákazníky.",
  },
  {
    icon: Smartphone,
    title: "Interaktivní vizitka",
    description: "Profil restaurace — kontakty, sociální sítě, speciality, služby, fotogalerie, mapa. Vše na jednom místě.",
  },
  {
    icon: CalendarDays,
    title: "Online rezervace stolů",
    description: "Hosté si rezervují přes vaši vizitku. Vy potvrdíte nebo odmítnete v dashboardu. Bez telefonátů.",
  },
  {
    icon: MessageSquare,
    title: "Zprávy a kontaktní formulář",
    description: "Přijímejte dotazy a zpětnou vazbu. Inbox v dashboardu s přehledem nepřečtených.",
  },
  {
    icon: Camera,
    title: "Fotogalerie s lightboxem",
    description: "Ukažte interiér, jídla a atmosféru. Fotky prodávají víc než slova.",
  },
  {
    icon: BarChart3,
    title: "Statistiky a analytika",
    description: "Zobrazení profilu, QR skeny, graf za 7 dní. Rozhodujte se na základě dat.",
  },
  {
    icon: Globe,
    title: "Widget pro vlastní web",
    description: "Vložte menu jako iframe na svůj web. Světlý/tmavý motiv, automatická aktualizace.",
  },
  {
    icon: TrendingUp,
    title: "Akce, Happy Hours a kupóny",
    description: "Události s kalendářem, časové slevy s countdown, slevové kódy. Přitáhněte hosty.",
  },
  {
    icon: Shield,
    title: "Sezónní menu a šablony",
    description: "Vánoční menu, letní gril — s datem od-do. Šablony denního menu pro opakované nabídky.",
  },
  {
    icon: Smartphone,
